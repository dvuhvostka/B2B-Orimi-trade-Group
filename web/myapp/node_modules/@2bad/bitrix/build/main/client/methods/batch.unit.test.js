...
describe('Client `chunkCommands` method', () => {
    it('should chunk named commands', () => {
        ...
        expect(batch_1.chunkCommands(commands, chunkSize)).toMatchSnapshot();
    });
    ...
    it('should by default chunk with a size of `MAX_COMMANDS_PER_BATCH`', () => {
        ...
        const commands = lodash_range_1.default(0, batch_1.MAX_COMMANDS_PER_BATCH * commandsSets).map(() => ({ method: methods_1.Method.CRM_DEAL_GET }));
        const chunked = batch_1.chunkCommands(commands);
...
describe('Client `prepareCommandsQueries` method', () => {
    it('should transform dict of the commands into the query object', () => {
        ...
        expect(batch_1.prepareCommandsQueries(commands)).toMatchSnapshot();
    });
    ...
    it('should return empty query object when no commands provided', () => {
        expect(batch_1.prepareCommandsQueries({})).toMatchSnapshot();
    });
});
describe('Client `mergeBatchPayloads` method', () => {
    it('should merge named payloads', () => {
        ...
        expect(batch_1.mergeBatchPayloads([batch1, batch2])).toMatchSnapshot();
    });
...
//# sourceMappingURL=batch.unit.test.js.map