...
declare const _default: ({ call, list }: Dependencies) => {
    ...
    create: <D extends {
        readonly fields: Partial<import("./entities").Deal>;
        readonly params?: {
    ...
    get: (id: string) => Promise<import("../../payloads").GetPayload<import("./entities").Deal>>;
    list: (params?: import("../../methods").ListParams) => Promise<import("../../payloads").ListPayload<import("./entities").Deal>>;
    update: <D_1 extends {
        readonly id: string;
