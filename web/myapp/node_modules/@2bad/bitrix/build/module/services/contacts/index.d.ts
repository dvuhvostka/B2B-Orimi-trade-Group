...
declare const _default: ({ call, list }: Dependencies) => {
    ...
    create: <D extends {
        readonly fields: Partial<import("./entities").Contact>;
        readonly params?: {
            readonly REGISTER_SONET_EVENT: import("../common").BoolString;
        } | undefined;
    }>(fields: D["fields"], params?: D["params"] | undefined) => Promise<import("../../payloads").GetPayload<number>>;
    get: (id: string) => Promise<import("../../payloads").GetPayload<import("./entities").Contact>>;
    list: (params?: import("../../methods").ListParams) => Promise<import("../../payloads").ListPayload<import("./entities").Contact>>;
    update: <D_1 extends {
        readonly id: string;
